...
#: The repository's front door. Nothing here writes it any more -- the root README is a hand-written
#: map, and the one row it gives this exercise links `SPEC.md` directly. The path stays because the
#: tests still read that row: it is hand-written prose that states a count, so a test asserts it.

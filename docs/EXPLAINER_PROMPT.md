...
Bold the **variables**, not the adjectives. In "the **volume collapses by a million times** and the **tolerance for noise** inverts," the bold marks the things that change — that's a promise the widget keeps.
...
### The assignment for these two surfaces

...
| 09 | [Loss functions and output heads](src/exercises/09-loss-functions-output-heads/) | What the last layer costs and what it decides: the output head and the loss it is trained against, built and measured rather than described. *In progress.* [The argument, the evidence and its limits](src/exercises/09-loss-functions-output-heads/README.md). *Scaffolded.* |
